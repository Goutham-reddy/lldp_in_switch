...
public class LLDPDiscoveryUtils {
   ...
   /* public static NodeConnectorRef lldpToNodeConnectorRef(byte[] payload)  {
     ...
     */
    public static byte[] getValueForLLDPPacketIntegrityEnsuring(final String nodeConnectorId) throws NoSuchAlgorithmException {
        String finalKey;
      /*  if(LLDPActivator.getLldpSecureKey() !=null && !LLDPActivator.getLldpSecureKey().isEmpty()) {
        ...
        finalKey = "aa9251f8-c7c0-4322-b8d6-c3a84593bda3";
     ...
     * @throws NoSuchAlgorithmException
     */
    private static boolean checkExtraAuthenticator(LLDP lldp, String srcNodeConnectorId) throws NoSuchAlgorithmException {
