...
import static lldpspeaker.LLDPDiscoveryUtils.getValueForLLDPPacketIntegrityEnsuring;
...
public final class LLDPUtil {
    ...
    static byte[] buildLldpFrame(final String nodeId,
            final String nodeConnectorId, final MacAddress src, final Long outPortNo,
    ...
    private static BigInteger dataPathIdFromNodeId(final String nodeId) {
    ...
    static byte[] buildLldpFrame(final String nodeId,
            final String nodeConnectorId, final MacAddress srcMacAddress,
